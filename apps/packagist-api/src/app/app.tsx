...
export class App extends Component<{}, PackagistState> {
  constructor(props) {
    super(props);
      ...
      <Container>
        ...
        <form className="form-inline" onSubmit={this.handleSubmit}>
          <div className="form-group mr-2 mb-2">
            ...
            <input className="form-control" required id="pack" type="text" placeholder="Package..." value={this.state.pack} onChange={this.handleChange} title="Type the package to search" />
          </div>
